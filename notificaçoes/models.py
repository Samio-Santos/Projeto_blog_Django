...
class Notification(models.Model):
    ...
    user_from = models.ForeignKey('accounts.User', on_delete=models.CASCADE, related_name="noti_from_user")
    user_to = models.ForeignKey('accounts.User', on_delete=models.CASCADE, related_name="noti_to_user")
